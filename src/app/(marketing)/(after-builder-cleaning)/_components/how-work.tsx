    ...
    const items = [
        {
            title: 'Book Online',
            description:
                'Book your post cleaning service online in 60 seconds.',
        },
        {
            title: 'We Clean',
            description:
                'Our cleaners in Wollongong will come over & professionally clean your renovated house.',
        },
        {
            title: 'You Relax',
            description: 'Sit back, relax and enjor your sparkle clean house.',
        },
    ];
