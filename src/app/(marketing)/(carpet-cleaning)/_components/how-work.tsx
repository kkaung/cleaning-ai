    ...
    const items = [
        {
            title: 'Book Online',
            description:
                'Book your carpet cleaning service online in 60 seconds.',
        },
        {
            title: 'We Clean',
            description: `Our carpet cleaners in ${location} will come to your home and thoroughly clean your carpets and rugs.`,
        },
        {
            title: 'You Relax',
            description:
                'Sit back, relax, and enjoy your sparkling clean carpet.',
        },
    ];
