            ...
            <article className="container relative max-w-3xl py-6 lg:py-10">
                ...
                <section className="bg-secondary/50 p-6 rounded-lg space-y-4 my-8">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm">
                            <Link href="/">{siteConfig.title}</Link> is a
                            top-rated house cleaning company in Canberra. We
                            offer tailored cleaning services for your homes,
                    ...
                    <ul className="grid grid-cols-1 gap-x-4 gap-y-2 text-sm">
                        <li>
                            <Link
                                ...
                                title="Deep Cleaning Service Canberra"
                            >
                                Deep Cleaning
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                title="Regular Cleaning Service Canberra"
                            >
                                Regular Cleaning
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link
                                ...
                                title="Carpet Cleaning Service Canberra"
                            >
                                Carpet Cleaning
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                title="Window Cleaning Service Canberra"
                            >
                                Window Cleaning
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                title="After Cleaning Service Canberra"
                            >
                        ...
                        <li>
                            <Link
                                href="/airbnb-cleaning-canberra"
                                title="Airbnb Cleaning Service Canberra"
                            >
                                Airbnb Cleaning
                            </Link>
                        </li>
